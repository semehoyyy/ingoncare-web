...
<div class="p-4 rounded-2xl bg-white transition"
    style="border:1.5px solid #EDE4F5; box-shadow:0 2px 8px rgba(159,134,192,0.04);"
        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between gap-2 flex-wrap">
                <div class="flex items-center gap-2">
                    <p class="font-semibold" style="color:#2D1B69;">
            ...
            <div class="mt-2">
                ...
                <h3 class="font-bold text-lg mb-2" style="color:#2D1B69;">{{ $comment->title }}</h3>
                @endif

                {{-- Content Text --}}
                <p class="break-words leading-relaxed text-sm" style="color:#4b5563;">
                    {{ $comment->content }}
                </p>
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium transition cursor-pointer"
            ...
            <div class="flex gap-6 text-sm mt-3 items-center flex-wrap" style="color:#9ca3af;">
                ...
                <button type="button"
                    ...
                    onmouseout="this.style.color='{{ $isLiked ? '#9F86C0' : '#9ca3af' }}'">
                ...
                <a href="{{ route('forum.show', $comment->id) }}"
                    ...
                    style="color:#5E4B8B;"
                    onmouseover="this.style.color='#2D1B69'"
                    onmouseout="this.style.color='#5E4B8B'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-4 hidden reply-form p-3.5 rounded-xl" style="background:#FDFAFF; border:1.5px solid #EDE4F5;" id="reply-form-{{ $comment->id }}">
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="flex-1">
                            <textarea name="content"
                                rows="2"
                                class="w-full rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 resize-none"
                                style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                                placeholder="Tulis balasan Anda..."
                                required></textarea>
                            <div class="flex gap-2 justify-end mt-2">
                                <button type="button"
                                    class="cancel-reply-btn px-3 py-1.5 text-xs rounded-lg transition"
                                ...
                                <button type="submit"
                                    class="text-white px-4 py-1.5 rounded-lg text-xs transition font-medium"
