        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl shadow-sm border border-cyan-100 p-6">
                ...
                <ul class="space-y-2 text-sm text-gray-700">
                    ...
                    <li class="flex items-start gap-2">
                        <span class="text-cyan-500">•</span>
                        <span>Cari berdasarkan nama pengguna</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-cyan-500">•</span>
                        <span>Cari topik diskusi tertentu</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-cyan-500">•</span>
                        <span>Gunakan kata berbeda jika tidak menemukan hasil</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('home') }}" 
                       class="block w-full text-center py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition font-medium">
                        🏠 Kembali ke Home
                    </a>
            ...
            {{-- Recent Searches (Optional - bisa dihapus jika tidak perlu) --}}
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-bold text-lg mb-4">Pencarian Populer</h3>
