    ...
    <div class="text-white px-6 py-5 rounded-2xl flex items-center justify-between mb-6"
        ...
        <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0"
                ...
                <i class="ti ti-edit text-white" style="font-size:22px;" aria-hidden="true"></i>
            </div>
            <div>
                <h2 class="text-xl font-bold">Edit Hewan Peliharaan</h2>
                <p class="text-sm" style="color:#EDE4F5;">Perbarui informasi hewan peliharaan</p>
            </div>
        </div>
    ...
    <form action="{{ route('pets.update', $pet->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="w-24 h-24 rounded-full overflow-hidden flex-shrink-0"
                    ...
                    @else
                        <div class="w-full h-full flex items-center justify-center">
                            ...
                            <i id="photoPlaceholder" class="ti ti-paw" style="font-size:30px; color:#CDB4DB;" aria-hidden="true"></i>
                        </div>
                    @endif
                </div>
                <div>
                    <label class="cursor-pointer px-5 py-2.5 rounded-xl text-sm font-semibold transition text-white inline-block"
        ...
        <div class="bg-white rounded-2xl p-6" style="border:1.5px solid #EDE4F5; box-shadow:0 2px 12px rgba(159,134,192,0.08);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    @error('species')<p class="text-xs mt-1" style="color:#ef4444;">{{ $message }}</p>@enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="breed" value="{{ old('breed', $pet->breed) }}" placeholder="Contoh: Golden Retriever"
                               class="w-full rounded-xl py-3 pl-11 pr-4 text-sm focus:outline-none"
                               style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                               onfocus="this.style.borderColor='#9F86C0'"
                               onblur="this.style.borderColor='#CDB4DB'">
                ...
                <div>
                    ...
                    @error('gender')<p class="text-xs mt-1" style="color:#ef4444;">{{ $message }}</p>@enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="birth_date"
                               value="{{ old('birth_date', $pet->birth_date ? \Carbon\Carbon::parse($pet->birth_date)->format('Y-m-d') : '') }}"
                               required
                               class="w-full rounded-xl py-3 pl-11 pr-4 text-sm focus:outline-none"
                               style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                               onfocus="this.style.borderColor='#9F86C0'"
                    ...
                    @error('birth_date')<p class="text-xs mt-1" style="color:#ef4444;">{{ $message }}</p>@enderror
                </div>
        ...
        <div class="bg-white rounded-2xl p-6" style="border:1.5px solid #EDE4F5; box-shadow:0 2px 12px rgba(159,134,192,0.08);">
            ...
            <textarea name="special_marks" rows="3"
                      placeholder="Contoh: Terdapat bercak hitam di kaki depan"
                      class="w-full rounded-xl px-4 py-3 text-sm focus:outline-none resize-none"
                      style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                      onfocus="this.style.borderColor='#9F86C0'"
                      onblur="this.style.borderColor='#CDB4DB'">{{ old('special_marks', $pet->special_marks) }}</textarea>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="allergies" value="{{ old('allergies', $pet->allergies) }}"
                               placeholder="Contoh: Alergi ayam"
                               class="w-full rounded-xl py-3 pl-11 pr-4 text-sm focus:outline-none"
                               style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                               onfocus="this.style.borderColor='#9F86C0'"
                               onblur="this.style.borderColor='#CDB4DB'">
                ...
                <div>
                    ...
                    <textarea name="health_notes" rows="3"
                              placeholder="Contoh: Diabetes, arthritis"
                              class="w-full rounded-xl px-4 py-3 text-sm focus:outline-none resize-none"
                              style="border:1.5px solid #CDB4DB; background:#FDFAFF;"
                              onfocus="this.style.borderColor='#9F86C0'"
                              onblur="this.style.borderColor='#CDB4DB'">{{ old('health_notes', $pet->health_notes) }}</textarea>
                </div>
            </div>
        </div>
